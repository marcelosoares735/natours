...
exports.dislpayMap = void 0;

/* eslint-disable */
var dislpayMap = function dislpayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFyY2Vsb3NvYXJlczczNSIsImEiOiJja3JtNTV1c3oxYjd0MndwODRjN3BodGp3In0.Z2n2YzFh8vSDrVMkB0HqAw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/marcelosoares735/ckrm5r7vg39uj17rwvuwq8pg8',
    scrollZoom: false
  });
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            res = _context2.sent;
            if (res.data.status === 'success') window.location.replace(window.location.href);
            _context2.next = 11;
            break;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:8000/api/v1/users/update-password' : 'http://127.0.0.1:8000/api/v1/users/update-me';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'patch',
              url: url,
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51JP73wIzKrbSV2PgUHQcXTpcxgeb201Mt3SibxduZcTt22CgnzrLeknEZjWq3HILiOnuiUvNdJ4c8jyXVeBKh1n000iBRRjY5C');
            console.log(stripe); // 1) Get checkout session from API
...
if (updateDataForm) {
  updateDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); // this is for sending multiform data. this is needed any time a file is uploaded. we have to append to the form all the data we want to send, including the file
