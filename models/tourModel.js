...
const tourSchema = new mongoose.Schema(
  {
    ...
    guides: [
      {
        // ID used form object referencing
...
// Performs embeding of the users into the tour
...
// QUERY MIDDLEWARE
// regular expression all methods that start with find
tourSchema.pre(/^find/, function (next) {
  // this points to a query object
...
//   // this points to an aggregation object
